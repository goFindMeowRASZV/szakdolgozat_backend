...
Route::middleware(['auth:sanctum'])
    ->group(function () {
        ...
        Route::get('/get-sheltered-reports-filter/{color},{pattern},{date1},{date2}', [ReportController::class, 'get_sheltered_reports_filter']);
        Route::get('/get-reports-filter/{color},{pattern},{date1},{date2}', [ReportController::class, 'get_reports_filter']);
